...
(
  ...
  BEAR_NAME VARCHAR2(100), -- 100 CHRACTERS OF SPACE
  -- VARCHAR2 INTERPRETS NULL AND EMPTY STRING AS THE SAME VALUE, UNLIKE VARCHAR
  BIRTHDATE DATE,
  WEIGHT NUMBER(6,2) DEFAULT 200.0,
...
/
 ...
 -- CONSTRAINT: RULE PLACED ON THE CONTENTS OF TABLE, LIMITING WHAT MAY BE INSERTED
